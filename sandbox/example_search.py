...
def main():
    ...
    keywords = ["землетрясение алматы", "магнитуда землетрясения в алматы", "эпицентр в алматы при землетрясение"]

    # instagram_df = searcher.search_to_dataframe(
    #     keywords, max_results=20, site_filter="instagram.com"
    # )
    ...
    # Search general web
    print("\nSearching web...")
    web_df = searcher.search_to_dataframe(keywords, max_results=20)
